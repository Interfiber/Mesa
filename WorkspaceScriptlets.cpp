...
Mesa::WorkspaceNameScriptlet::WorkspaceNameScriptlet()
{
	name = "Workspace";
}

void Mesa::WorkspaceNameScriptlet::onRun(std::shared_ptr<Workspace> workspace, const std::string& value)
{
...
Mesa::VariableScriptlet::VariableScriptlet()
{
	name = "Variable";
}

void Mesa::VariableScriptlet::onRun(std::shared_ptr<Workspace> workspace, const std::string& value)
{
	std::string k, v;
...
Mesa::ImportScriptlet::ImportScriptlet()
{
	name = "Import";
}

void Mesa::ImportScriptlet::onRun(std::shared_ptr<Workspace> workspace, const std::string& val)
{
...
Mesa::PropertyScriptlet::PropertyScriptlet()
{
	name = "Property";
}

void Mesa::PropertyScriptlet::onRun(std::shared_ptr<Workspace> workspace, const std::string& value)
{
	std::string k, v;
