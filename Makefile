...
Scriptlets_STATIC_LIBS := $(BIN_DIR)/MesaUtils 
Scriptlets_DYN_LIBS := 
Mesa_Base_INCDIRS := $(wildcard include/*.h) $(wildcard include/*.hpp) $(wildcard SDL/include/*.h) $(wildcard SDL/include/*.hpp) 
Mesa_Base_CPPFLAGS := -DBUILD_DATE=Sun\ Aug\ \ 4\ 12:13:35\ 2024 -DBUILD_UNIX=1722788015 -Iinclude -ISDL/include  -O3 -g -std=c++17
Mesa_Base_LDFLAGS := -L$(BIN_DIR) 
Mesa_Base_STATIC_LIBS := $(BIN_DIR)/MesaScriptlets $(BIN_DIR)/MesaUtils 
Mesa_Base_DYN_LIBS := 
...
$(OBJ_DIR)/Scriptlets/src_PkgConfigScriptlets.cpp.o: src/PkgConfigScriptlets.cpp $(Scriptlets_INCDIRS)
	@echo $(COLOR_BLUE)[CXX]$(COLOR_NORM) src/PkgConfigScriptlets.cpp
	@$(CXX) $(CPPFLAGS) $(Scriptlets_CPPFLAGS) $(I_CPPFLAGS) -c src/PkgConfigScriptlets.cpp -o $(OBJ_DIR)/Scriptlets/src_PkgConfigScriptlets.cpp.o

Scriptlets: Prep $(OBJ_DIR)/Scriptlets/src_ProjectScriptlets.cpp.o $(OBJ_DIR)/Scriptlets/src_StdScriptlets.cpp.o $(OBJ_DIR)/Scriptlets/src_WorkspaceScriptlets.cpp.o $(OBJ_DIR)/Scriptlets/src_CMakeScriptlets.cpp.o $(OBJ_DIR)/Scriptlets/src_PkgConfigScriptlets.cpp.o 
	@echo $(COLOR_GREEN)[LIB]$(COLOR_NORM) Linking Scriptlets \> $(STYLE_ULINE)$(BIN_DIR)/MesaScriptlets.a$(STYLE_NORM)
	@ar rcs $(BIN_DIR)/MesaScriptlets.a $(OBJ_DIR)/Scriptlets/src_ProjectScriptlets.cpp.o $(OBJ_DIR)/Scriptlets/src_StdScriptlets.cpp.o $(OBJ_DIR)/Scriptlets/src_WorkspaceScriptlets.cpp.o $(OBJ_DIR)/Scriptlets/src_CMakeScriptlets.cpp.o $(OBJ_DIR)/Scriptlets/src_PkgConfigScriptlets.cpp.o 
