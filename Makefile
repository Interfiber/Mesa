...
Mesa_Base_CPPFLAGS := -DBUILD_DATE=Thu\ Aug\ \ 1\ 15:19:39\ 2024 -DBUILD_UNIX=1722539979 -I. -ILibraries/Include  -O3 -g -std=c++17
...
Mesa_Base: Prep $(OBJ_DIR)/Mesa_Base/Mesa.cpp.o $(OBJ_DIR)/Mesa_Base/MesaParser.cpp.o $(OBJ_DIR)/Mesa_Base/MesaMakefileGenerator.cpp.o $(OBJ_DIR)/Mesa_Base/MesaProcessor.cpp.o 
	...
	@$(CXX) -o $(BIN_DIR)/Mesa $(OBJ_DIR)/Mesa_Base/Mesa.cpp.o $(OBJ_DIR)/Mesa_Base/MesaParser.cpp.o $(OBJ_DIR)/Mesa_Base/MesaMakefileGenerator.cpp.o $(OBJ_DIR)/Mesa_Base/MesaProcessor.cpp.o  $(Mesa_Base_LDFLAGS) $(Mesa_Base_STATIC_LIBS)
